...
description: How to use RPI, a context engineering technique, on complex software projects
---
...
In goose, we use a structured RPI workflow using recipes to systematically
tackle complex codebase changes. The workflow consists of slash commands that
guide goose through disciplined phases of work:
